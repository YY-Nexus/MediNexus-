      ...
      <DialogContent className="sm:max-w-[500px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>填写以下信息创建新的系统任务</DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <Input id="task-name" placeholder="输入任务名称" className="col-span-3" required />
            </div>
            <div className="grid grid-cols-4 items-center gap-4">
            ...
            {scheduleType !== "once" && (
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="time" type="time" className="col-span-3" required={scheduleType !== "once"} />
              </div>
            )}
            ...
            <div className="grid grid-cols-4 items-start gap-4">
              ...
              <Textarea id="description" placeholder="输入任务描述和详细信息" className="col-span-3" rows={3} />
            </div>
